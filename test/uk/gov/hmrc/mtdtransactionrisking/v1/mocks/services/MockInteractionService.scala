...
trait MockInteractionService extends MockFactory:
  ...
  val mockInteractionService: InteractionService = mock[InteractionService]

  object MockInteractionService:

    def store(feedback: FeedbackResponse, obligation: Obligation, vrn: String, vendorBody: JsValue): CallHandler[Unit] =
