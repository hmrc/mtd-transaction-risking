...
trait MockRdsAuthService extends MockFactory:
  this: TestSuite =>

  val mockRdsAuthService: RdsAuthService = mock[RdsAuthService]

  object MockRdsAuthService:

    def bearerToken: CallHandler[Future[ServiceOutcome[Option[RdsAuthCredentials]]]] =
      (mockRdsAuthService
        .bearerToken()(_: HeaderCarrier, _: CorrelationId))
        .expects(*, *)
